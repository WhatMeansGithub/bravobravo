...
def open_downloads_playlist():
    global downloads_window, listbox, bg_label_playlist
    root.destroy()  # Close the root window when the downloads window is opened
    downloads_window = customtkinter.CTk()
    downloads_window.title("Downloads and Playlist")
    downloads_window.geometry("500x540")
